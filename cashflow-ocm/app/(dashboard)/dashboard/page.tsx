  ...
  const metricCards = [
    {
      ...
      icon: <Banknote className="h-5 w-5 text-green-600 dark:text-[#6b6b6b]" />,
    ...
    },
    {
      ...
      icon: <TrendingDown className="h-5 w-5 text-amber-600 dark:text-[#6b6b6b]" />,
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-5 w-5 text-violet-600 dark:text-[#6b6b6b]" />,
    ...
    },
    {
      ...
      icon: <Receipt className="h-5 w-5 text-emerald-600 dark:text-[#6b6b6b]" />,
    ...
    <div className="space-y-6 pt-1 md:pt-0">
      ...
      <div className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card overflow-hidden">
        <div className="px-5 py-3 border-b border-stone-50 dark:border-border flex items-center gap-2">
          <span className="h-1.5 w-1.5 rounded-full bg-green-500 dark:bg-[#3a3a3a]" />
          <p className="text-[11px] font-semibold uppercase tracking-widest text-stone-400 dark:text-[#6b6b6b]">Hari Ini</p>
        </div>
          ...
          {todayItems.map((item) => (
            <div key={item.label} className="flex items-center justify-between px-5 py-4 sm:flex-col sm:items-start sm:py-5">
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-xs text-stone-400 dark:text-[#6b6b6b] font-medium">{item.label}</p>
              </div>
      ...
      {/* Saldo per akun */}
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-widest text-stone-400 dark:text-[#6b6b6b] mb-3">Saldo Rekening &amp; Kas</p>
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          {akunCvOcm && (
            <div className="rounded-xl border border-orange-200/80 dark:border-border bg-gradient-to-br from-orange-50/80 to-white dark:bg-card p-4">
              <p className="text-[10px] font-semibold text-orange-500 dark:text-[#6b6b6b] uppercase tracking-widest mb-2">Rekening Utama</p>
              <p className="text-[11px] text-stone-400 dark:text-[#6b6b6b] mb-1.5 truncate">{akunCvOcm.nama}</p>
          ...
          {akunLainnya.length > 0 && (
            <div className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card p-4">
              <p className="text-[10px] font-semibold text-stone-400 dark:text-[#6b6b6b] uppercase tracking-widest mb-2">Bank</p>
              <p className="text-[11px] text-stone-400 dark:text-[#6b6b6b] mb-1.5">Rek BRI Lainnya</p>
              ...
              <p className="text-[10px] text-stone-300 dark:text-[#525252] mt-2 truncate">{akunLainnya.map((a) => a.nama).join(' · ')}</p>
            </div>
          )}
          {/* Tunai */}
          {akunTunai.map((a) => (
            <div key={a.id} className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card p-4">
              <p className="text-[10px] font-semibold text-stone-400 dark:text-[#6b6b6b] uppercase tracking-widest mb-2">Tunai</p>
              <p className="text-[11px] text-stone-400 dark:text-[#6b6b6b] mb-1.5 truncate">{a.nama}</p>
        ...
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card overflow-hidden">
            <div className="px-5 py-4 border-b border-stone-50 dark:border-border">
              ...
              <p className="text-xs text-stone-400 dark:text-[#6b6b6b] mt-0.5">Masuk vs keluar — 14 hari terakhir</p>
            </div>
            <div className="p-4">
        ...
        <div>
          <div className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card overflow-hidden">
            <div className="px-5 py-4 border-b border-stone-50 dark:border-border">
              ...
              <p className="text-xs text-stone-400 dark:text-[#6b6b6b] mt-0.5">Bank, Tunai, DP Peron, Piutang</p>
            </div>
            <div className="p-4">
      ...
      <div className="rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-card overflow-hidden">
        <div className="px-5 py-4 border-b border-stone-50 dark:border-border">
          ...
          <p className="text-xs text-stone-400 dark:text-[#6b6b6b] mt-0.5">Perkembangan modal selama 14 hari terakhir</p>
        </div>
        <div className="p-4">
