      ...
      <div className="surface p-4">
        <div className="flex items-center gap-3.5">
          ...
          {telegramConfigured ? (
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--warn-fg)]/25 bg-[var(--warn-bg)] px-3 py-1 text-xs font-semibold text-[var(--warn-fg)]">
