...
/** Segmen "Daftar" — isi lama halaman /peron (hero Total DP + tabel + FAB). */
export async function DaftarView({ isOwner }: { isOwner: boolean }) {
  const [peronList, akunList] = await Promise.all([
    getPeronList(),
