 ...
 * Tanggal header) — picker bawaan OS, andal, langsung bisa diklik. "Sampai" muncul
 * sebagai input kedua opsional begitu "Dari" terisi; kosongkan untuk tanggal tunggal.
 */
    ...
    <div className="flex flex-col gap-1 min-w-0">
      <div className="flex items-center gap-1 min-w-0">
        <Input
          ...
          className={cn('h-8 text-xs px-1.5 min-w-0 text-stone-600 dark:text-zinc-300', className)}
        />
        {warning && (
      ...
      {showSampai && (
        <div className="flex items-center gap-1 min-w-0">
          ...
          <Input
            ...
            className="h-7 text-xs px-1.5 min-w-0 flex-1 text-stone-600 dark:text-zinc-300"
          />
          {sampai && (
            <button
              type="button"
              ...
              className="shrink-0 px-1 text-stone-400 hover:text-red-500 text-sm leading-none"
            >
              ×
            </button>
          )}
